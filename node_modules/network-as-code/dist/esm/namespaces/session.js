...
import { QoDSession } from "../models/session.js";
    ...
    */
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield this.api.sessions.getSession(id);
            return QoDSession.convertSessionModel(this.api, yield session.device, session);
        });
    }
}
