...
export class Devices extends Namespace {
     ...
     *      @param DeviceGetArgs (object):
            ...
            @returns Device
    */
    get({ networkAccessIdentifier, ipv4Address, ipv6Address, phoneNumber, }) {
        if (!networkAccessIdentifier &&
            !ipv4Address &&
            !ipv6Address &&
            !phoneNumber) {
            throw new Error("At least one parameter must be set.");
        }
        let retDevice = new Device(this.api, networkAccessIdentifier, ipv4Address, ipv6Address, phoneNumber);
        return retDevice;
    }
}
